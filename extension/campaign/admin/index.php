         ...
         <div class="main_container">
             <div class="col-md-3 left_col">
                 <div class="left_col scroll-view">
                     <div class="navbar nav_title" style="border: 0;">
                         <a href="../index.php" class="site_title"><i class="fa fa-envelope"></i> <span>Email Builder</span></a>
                     </div>
             ...
             <footer class="footer_fixed">
                 <div class="pull-right">
                   Bal - Email Newsletter Builder by <a href="https://codecanyon.net/user/askerov/portfolio?ref=askerov">Askerov</a>
                 </div>
                 <div class="clearfix"></div>
             </footer>
             <!-- /footer content -->
