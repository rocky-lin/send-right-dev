	...
	var form = jQuery('#FORMCONTAINER_ID');
	...
	form.on('click', 'img.cfgen-captcha-refresh', function(){
		...
		form.find('img.cfgen-captcha-img').prop('src','FORM_INC_DIR/inc/captcha.php?r='+Math.random());
	...
	form.on('click', 'input[type="submit"].cfgen-submit', function(){
		...
		jQuery.post('FORM_INC_DIR/inc/form-validation.php',
					post,
					function(data){
